...
SET MIF_CONNECTORS_ENV_PARAMS=%MIF_CONNECTORS_ENV_PARAMS% -Dconverter.toolbox.executable="%SEE_HOME%\converter-toolbox-distribution\converter-toolbox\convert.bat"
